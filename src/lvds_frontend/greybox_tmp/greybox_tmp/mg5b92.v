//altlvds_rx BUFFER_IMPLEMENTATION="RAM" CBX_SINGLE_OUTPUT_FILE="ON" clk_src_is_pll="off" COMMON_RX_TX_PLL="OFF" DATA_RATE=""1000.0 Mbps"" DESERIALIZATION_FACTOR=8 ENABLE_DPA_CALIBRATION="ON" ENABLE_DPA_MODE="OFF" ENABLE_SOFT_CDR_MODE="OFF" IMPLEMENT_IN_LES="OFF" INCLOCK_BOOST=0 INCLOCK_PERIOD=2000 INCLOCK_PHASE_SHIFT=0 INPUT_DATA_RATE=1000 INTENDED_DEVICE_FAMILY=""Cyclone V"" LPM_TYPE="altlvds_rx" NUMBER_OF_CHANNELS=32 OUTCLOCK_RESOURCE=""Dual-Regional clock"" PLL_OPERATION_MODE="NORMAL" PORT_RX_CHANNEL_DATA_ALIGN="PORT_UNUSED" PORT_RX_DATA_ALIGN="PORT_UNUSED" REFCLK_FREQUENCY=""500.000000 MHz"" REGISTERED_OUTPUT="ON" RX_ALIGN_DATA_REG="RISING_EDGE" SIM_DPA_OUTPUT_CLOCK_PHASE_SHIFT=0 USE_CORECLOCK_INPUT="OFF" USE_EXTERNAL_PLL="OFF" X_ON_BITSLIP="ON" rx_in rx_inclock rx_out rx_outclock
